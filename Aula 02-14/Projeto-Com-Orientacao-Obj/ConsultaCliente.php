...
class ConsultaCliente extends ConsultaPadrao{
        ...
        return '<div class="modal" id="modal">
                <div class="modal-content">
                    ...
                    <form id="form" class="modal-form">
                        ...
                        <input type="text" id="telefone" class="modal-field" placeholder="Telefone..." required value="(47)999441914">
                        <input type="text" id="email" class="modal-field" placeholder="e-mail..." required value="joao@email.com">
    ...
    protected function getCabecalhoTabela() {
